...
public class panel extends JPanel implements ActionListener
{
    ...
    public void draw(Graphics g)
    {
        if(running)
        {
            ...
            g.setColor(Color.red);
            g.setFont(new Font("Silom",Font.BOLD,40));
            FontMetrics m = getFontMetrics(g.getFont());
            g.drawString("SCORE:"+appleEaten,(SCREEN_WIDTH - m.stringWidth("SCORE:"+appleEaten))/2,g.getFont().getSize());
        }
        else
        {
            gameOver(g);
    ...
    public void gameOver(Graphics g)
    {
        ...
        g.setColor(Color.red);
        g.setFont(new Font("Silom",Font.BOLD,75));
